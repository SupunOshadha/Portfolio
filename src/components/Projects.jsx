        ...
        <div id='Portfolio'>
          <h1 className='text-center text-4xl pt-14 '>Portfolio</h1>
            <div className='m-auto flex flex-row justify-center gap-4 w-full h-screen -mt-20'>
              ...
              <h3 className='p-2 text-white  text-2xl md:text-4xl '>Ceylon Travel</h3><p className=' pt-2 md:p-4 text-xl md:text-2xl'>A web site which is promoting the sri lanka tourism industry. <span className='hidden md:block'>Using html,css,javascript, and vuejs </span></p>
              </div>            
              </a>   
              </div> 
              </div>  
