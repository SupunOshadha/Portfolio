...
const Hero = () => {
  return (
    ...
    <div className='z-20'>  
      ...
      <img src={Person} className='grayscale  rounded w-2/3 h-1/3  md:max-h-screen z-10 opacity-60 m-auto mix-blend-lighten  hover:filter-none hover:animate-bounce
      '/> 
      </div>
      </div>
    </section>
