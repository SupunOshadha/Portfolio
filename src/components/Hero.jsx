...
const Hero = () => {
  return (
    ...
    <div className='z-20'>  
      ...
      <img src={Person} className='grayscale  w-1/2 h-1/3 rounded md:w-full md:min-h-96  md:max-h-screen z-10 opacity-60  mix-blend-lighten  hover:filter-none hover:animate-bounce m-auto
      '/> 
      </div>
      </div>
    </section>
