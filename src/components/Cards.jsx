    ...
    <section>
        <div className='grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8 grid  md:grid-flow-row p-7 m-4  justify-items-between '>
            {skillsData.skills.map(skill => (
                <div className='  md:max-w-md bg-zinc-800 overflow-auto shadow-2xl hover:bg-orange-400 rounded-3xl justify-items-center shadow-green content-center min-w-96 min-h-80 sm:min-w-40' key={skill}>
